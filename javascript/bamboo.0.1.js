...
var Bamboo = (function (window, document) {
	...
	// Events
	resizeEvent = 'onorientationchange' in window ? 'orientationchange' : 'resize',x
	...
	Bamboo = function (opts) {
		...
		// add required html
		cover = $('<div id="cover" />');
		container.find('#content').append(cover);
	...
	Bamboo.prototype = {
		...
		*/
		...
		_bindEvents: function(){
            ...
            layerBlank.on('touchstart mousedown', function(e) {
            	e.preventDefault();
            	_this._start(e);
            	// move
                $body.on('touchmove.bmboo mousemove.bmboo', function(e) {
...
//				});
				...
				//layerBlank.animate({display:'block'}, 1000);
				layerBlank.css({
					'display' : 'block'
				});
				layerBlank2.css({
